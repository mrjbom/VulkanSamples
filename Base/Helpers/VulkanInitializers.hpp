...
namespace vulkanInitializers
{
    ...
    inline VkPipelineShaderStageCreateInfo pipelineShaderStageCreateInfo(VkShaderStageFlagBits stage, VkShaderModule shaderModule, const char* entryPointName = "main")
    {
        ...
        shaderStaheCreateInfo.pName = entryPointName;
